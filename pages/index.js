...
export default function Home() {
  ...
  const [finishTone, setFinishTone] = useState('neutral')
  const [finishStrength, setFinishStrength] = useState(70)
        ...
        <main className="studio-shell">
          <section className="studio-panel">
            ...
            <div className="render-actions">
              <div className="control-group">
                <h4>Finish controls</h4>
                <label className="field">
                  <span>Concrete tone</span>
                  <select
                    value={finishTone}
                    onChange={(event) => setFinishTone(event.target.value)}
                  >
                    <option value="neutral">Neutral grey</option>
                    <option value="warm">Warm grey</option>
                    <option value="cool">Cool grey</option>
                    <option value="light">Light concrete</option>
                ...
                <label className="field">
                  ...
                  <input
                    ...
                    onChange={(event) => setFinishStrength(Number(event.target.value))}
                  />
                  <span className="field-hint">{finishStrength}%</span>
                </label>
                <label className="field">
                  <span>Custom notes</span>
                  <textarea
                    rows="3"
                    placeholder="e.g. add subtle expansion joints, matte seal, soft mottling"
                    value={finishNotes}
